...
/**
 * ArtisinalStreamingTest illustrates how to write a streaming test without using spark-testing-bases' specialized streaming support. This is not
 * intended to be a class you should base your implementation on, rather it is intended to disuade you from writing it by hand. This does not use a
 * manual clock and instead uses the kind of sketchy sleep approach. Instead please look at [[SampleStreamingTest]].
 */
